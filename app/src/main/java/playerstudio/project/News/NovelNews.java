 ...
 */
public class NovelNews extends Fragment {
    ...
    public void requestNew() {
        ...
        String address = "http://2324k8108v.iok.la:22557/news/getlist?page=5&type=novel&start="+page;    // key
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder()
                            .url("http://2324k8108v.iok.la:22557/news/getlist?page=4&type=novelbanner&start=1").build();
