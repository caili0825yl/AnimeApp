...
public class GameNews extends Fragment {
    ...
    public void requestNew() {
        ...
        String address =  "http://2324k8108v.iok.la:22557/news/getlist?page=5&type=game&start="+page;    // key
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder()
                            .url("http://2324k8108v.iok.la:22557/news/getlist?page=4&type=gamebanner&start=1").build();
